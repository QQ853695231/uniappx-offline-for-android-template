...
open class GenUniModulesCoolUiComponentsClButtonClButton : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesCoolUiComponentsClButtonClButton) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenUniModulesCoolUiComponentsClButtonClButton
            ...
            val pt = computed(fun(): PassThrough3 {
                return parsePt<PassThrough3>(props.pt)
            }
            )
                        ...
                        _cE(Fragment, _uM("key" to 2), _uA(
                            _cV(_component_cl_text, _uM("color" to textColor.value, "pt" to object : UTSJSONObject() {
                                var className = unref(parseClass)(_uA(
                                    "cl-button__label",
                                    object : UTSJSONObject() {
                                        var `-important-text-sm` = _ctx.size == "small"
                                    },

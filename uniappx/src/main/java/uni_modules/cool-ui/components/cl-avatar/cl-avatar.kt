...
open class GenUniModulesCoolUiComponentsClAvatarClAvatar : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesCoolUiComponentsClAvatarClAvatar) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenUniModulesCoolUiComponentsClAvatarClAvatar
            val _cache = __ins.renderCache
            val props = __props
            val pt = computed(fun(): PassThrough14 {
                return parsePt<PassThrough14>(props.pt)
            }
            )
            return fun(): Any? {

...
open class GenUniModulesCoolUiComponentsClSelectTriggerClSelectTrigger : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesCoolUiComponentsClSelectTriggerClSelectTrigger) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenUniModulesCoolUiComponentsClSelectTriggerClSelectTrigger
            ...
            val pt = computed(fun(): PassThrough11 {
                return parsePt<PassThrough11>(props.pt)
            }
            )
                            ...
                            _cV(_component_cl_text, _uM("key" to 0, "pt" to object : UTSJSONObject() {
                                var className = unref(parseClass)(_uA(
                                    object : UTSJSONObject() {
                                        var `-important-text-surface-400` = isDisabled.value
                                    },
                    ...
                    if (isTrue(!isDisabled.value && !showText.value)) {
                        _cE("view", _uM("key" to 1, "class" to "cl-select-trigger__icon"), _uA(
                            _cV(_component_cl_icon, _uM("name" to (pt.value.icon?.name ?: _ctx.arrowIcon), "size" to (pt.value.icon?.size ?: 32), "pt" to object : UTSJSONObject() {
                                var className = "-important-text-surface-400 " + pt.value.icon?.className
                            }), null, 8, _uA(
                                "name",
                                "size",
                                "pt"

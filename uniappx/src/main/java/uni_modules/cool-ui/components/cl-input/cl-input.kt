...
open class GenUniModulesCoolUiComponentsClInputClInput : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesCoolUiComponentsClInputClInput, _arg1: SetupContext) -> Any? = fun(__props, ref1): Any? {
            var __expose = ref1.expose
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenUniModulesCoolUiComponentsClInputClInput
            ...
            val pt = computed(fun(): PassThrough27 {
                return parsePt<PassThrough27>(props.pt)
            }
            )

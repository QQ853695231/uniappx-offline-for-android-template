...
open class GenUniModulesCoolUiComponentsClPickerViewClPickerView : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesCoolUiComponentsClPickerViewClPickerView) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenUniModulesCoolUiComponentsClPickerViewClPickerView
                        ...
                        _cE("view", _uM("key" to 0, "class" to "cl-picker-view__header"), _uA(
                            _cE(Fragment, null, RenderHelpers.renderList(headers.value, fun(label, index, __index, _cached): Any {
                                return _cV(_component_cl_text, _uM("pt" to object : UTSJSONObject() {
                                    var className = "flex-1 -important-text-sm text-center"
        ...
        ), "itemHeight" to _uM("type" to "Number", "default" to 42), "height" to _uM("type" to "Number", "default" to 600)))

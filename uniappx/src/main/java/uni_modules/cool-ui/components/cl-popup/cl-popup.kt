...
open class GenUniModulesCoolUiComponentsClPopupClPopup : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesCoolUiComponentsClPopupClPopup, _arg1: SetupContext) -> Any? = fun(__props, ref1): Any? {
            var __expose = ref1.expose
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenUniModulesCoolUiComponentsClPopupClPopup
            val _cache = __ins.renderCache
            val props = __props
            fun emit(event: String, vararg do_not_transform_spread: Any?) {
                __ins.emit(event, *do_not_transform_spread)
            }
            val pt = computed(fun(): PassThrough5 {
                return parsePt<PassThrough5>(props.pt)
            }
            )
                                    ...
                                    _cE("view", _uM("key" to 1, "class" to _nC(_uA(
                                        ...
                                        if (isTrue(isOpen.value && _ctx.showClose)) {
                                            _cV(_component_cl_icon, _uM("key" to 0, "name" to "close-circle-fill", "size" to 40, "pt" to object : UTSJSONObject() {
                                                var className = "absolute right--bracket-start-24rpx-bracket-end- -important-text-surface-400 "
                                            }, "onClick" to close, "onTouchmove" to withModifiers(fun(){}, _uA(
                                                "stop"
                                            )), "class" to _nC(_uM("dark-colon--important-text-surface-50" to unref(isDark)))), null, 8, _uA(
                                                "onTouchmove",
                                                "class"
                                            ))
                                        } else {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("cl-popup-wrapper" to _pS(_uM("height" to "100%", "width" to "100%", "position" to "fixed", "top" to 0, "bottom" to 0, "left" to 0, "right" to 0, "pointerEvents" to "none")), "cl-popup-mask" to _uM(".cl-popup-wrapper " to _uM("position" to "absolute", "top" to 0, "bottom" to 0, "left" to 0, "right" to 0, "height" to "100%", "width" to "100%", "backgroundColor" to "rgba(0,0,0,1)", "opacity" to 0, "transitionProperty" to "opacity"), ".cl-popup-wrapper .is-open" to _uM("opacity" to 0.4, "transitionDuration" to "0.3s"), ".cl-popup-wrapper .is-close" to _uM("transitionDuration" to "0.3s")), "cl-popup" to _uM(".cl-popup-wrapper " to _uM("position" to "absolute"), ".cl-popup-wrapper .is-open" to _uM("transform" to "translate(0, 0) scale(1)", "opacity" to 1, "transitionProperty" to "transform,opacity", "transitionDuration" to "0.3s"), ".cl-popup-wrapper .is-close" to _uM("transitionProperty" to "transform,opacity", "transitionDuration" to "0.3s"), ".cl-popup-wrapper .stop-transition" to _uM("transitionProperty" to "none"), ".cl-popup-wrapper--left " to _uM("left" to 0, "top" to 0, "transform" to "translateX(-100%)"), ".cl-popup-wrapper--right " to _uM("right" to 0, "top" to 0, "transform" to "translateX(100%)"), ".cl-popup-wrapper--top " to _uM("left" to 0, "top" to 0, "transform" to "translateY(-100%)"), ".cl-popup-wrapper--left .is-custom-navbar" to _uM("top" to 0), ".cl-popup-wrapper--right .is-custom-navbar" to _uM("top" to 0), ".cl-popup-wrapper--top .is-custom-navbar" to _uM("top" to 0), ".cl-popup-wrapper--bottom " to _uM("left" to 0, "bottom" to 0, "transform" to "translateY(100%)"), ".cl-popup-wrapper--center " to _uM("transform" to "scale(1.3)", "opacity" to 0)), "cl-popup__inner" to _uM(".cl-popup-wrapper " to _uM("display" to "flex", "height" to "100%", "width" to "100%", "flexDirection" to "column", "backgroundColor" to "rgba(255,255,255,1)"), ".cl-popup-wrapper .is-dark" to _uM("backgroundColor" to "rgba(63,63,70,1)"), ".cl-popup-wrapper--top " to _uM("borderBottomRightRadius" to "28rpx", "borderBottomLeftRadius" to "28rpx"), ".cl-popup-wrapper--bottom " to _uM("borderTopLeftRadius" to "28rpx", "borderTopRightRadius" to "28rpx"), ".cl-popup-wrapper--center " to _uM("borderTopLeftRadius" to "28rpx", "borderTopRightRadius" to "28rpx", "borderBottomRightRadius" to "28rpx", "borderBottomLeftRadius" to "28rpx")), "cl-popup__draw" to _uM(".cl-popup-wrapper " to _uM("borderTopLeftRadius" to "10.5rpx", "borderTopRightRadius" to "10.5rpx", "borderBottomRightRadius" to "10.5rpx", "borderBottomLeftRadius" to "10.5rpx", "backgroundColor" to "rgba(228,228,231,1)", "position" to "absolute", "top" to "14rpx", "left" to "50%", "height" to "10rpx", "width" to "70rpx", "transform" to "translateX(-50%)", "transitionProperty" to "backgroundColor", "transitionDuration" to "0.2s")), "cl-popup__header" to _uM(".cl-popup-wrapper " to _uM("display" to "flex", "flexDirection" to "row", "alignItems" to "center", "height" to "90rpx", "paddingTop" to 0, "paddingRight" to "26rpx", "paddingBottom" to 0, "paddingLeft" to "26rpx")), "cl-popup__container" to _uM(".cl-popup-wrapper " to _uM("flex" to 1)), "cl-popup-wrapper--center" to _pS(_uM("display" to "flex", "flexDirection" to "column", "alignItems" to "center", "justifyContent" to "center")), "@TRANSITION" to _uM("cl-popup-mask" to _uM("property" to "opacity", "duration" to "0.3s"), "cl-popup__draw" to _uM("property" to "backgroundColor", "duration" to "0.2s"), "cl-popup" to _uM("property" to "none", "duration" to "0.3s")))
            }

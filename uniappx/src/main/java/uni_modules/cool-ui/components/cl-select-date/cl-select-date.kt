...
open class GenUniModulesCoolUiComponentsClSelectDateClSelectDate : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesCoolUiComponentsClSelectDateClSelectDate, _arg1: SetupContext) -> Any? = fun(__props, ref1): Any? {
            var __expose = ref1.expose
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenUniModulesCoolUiComponentsClSelectDateClSelectDate
            ...
            val pt = computed(fun(): PassThrough22 {
                return parsePt<PassThrough22>(props.pt)
            }
            )
            ...
            val list = computed(fun(): UTSArray<UTSArray<ClSelectOption>> {
                ...
                val _dayUts_toArray1 = dayUts(props.end).toArray()
                val endYear = _dayUts_toArray1[0]
                val endMonth = _dayUts_toArray1[1]
                val endDate = _dayUts_toArray1[2]
                val endHour = _dayUts_toArray1[3]
                val endMinute = _dayUts_toArray1[4]
                val endSecond = _dayUts_toArray1[5]
            ...
            return fun(): Any? {
                ...
                return _cE(Fragment, null, _uA(
                    if (isTrue(_ctx.showTrigger)) {
                        ...
                        }, "placeholder" to _ctx.placeholder, "disabled" to _ctx.disabled, "focus" to popupRef.value?.isOpen, "text" to text.value, "arrow-icon" to "calendar-line", "onOpen" to fun(){
                            open()
                                            ...
                                            _cE("view", _uM("class" to _nC(_uA(
                                                ...
                                                if (isTrue(values.value.length > 0 && values.value[0] != "")) {
                                                    ...
                                                    _cV(_component_cl_text, _uM("key" to 1, "pt" to object : UTSJSONObject() {
                                                        var className = "text-center -important-text-surface-400"
                                                    }), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                                        return _uA(

...
open class GenPagesDemoFormCheckbox : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesDemoFormCheckbox) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenPagesDemoFormCheckbox
            ...
            val checked = ref(_uA<String>())
            val checked2 = ref(_uA<String>("2"))
            val checked3 = ref(_uA<String>("2", "3"))
            val checked4 = ref(false)
            val options = ref(_uA<ClCheckboxOption>(ClCheckboxOption(label = "Vue", value = "1"), ClCheckboxOption(label = "React", value = "2"), ClCheckboxOption(label = "Angular", value = "3"), ClCheckboxOption(label = "Svelte", value = "4")))
            return fun(): Any? {
                ...
                return _cV(_component_cl_page, null, _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cE("view", _uM("class" to "p-3"), _uA(
                                ...
                                return _uA(
                                    _cE("view", _uM("class" to "flex flex-row flex-wrap"), _uA(
                                        _cE(Fragment, null, RenderHelpers.renderList(options.value, fun(item, index, __index, _cached): Any {
                                            return _cV(_component_cl_checkbox, _uM("modelValue" to checked2.value, "onUpdate:modelValue" to fun(`$event`: UTSArray<String>){
                            ...
                            _cV(unref(GenPagesDemoComponentsItemClass), _uM("label" to unref(t)("单个 true / false")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                return _uA(
                                    _cE("view", _uM("class" to "flex flex-row items-center"), _uA(
                                        _cV(_component_cl_checkbox, _uM("modelValue" to checked4.value, "onUpdate:modelValue" to fun(`$event`: Boolean){
                                            checked4.value = `$event`
                                        }
                                        ), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                            return _uA(
                                                "同意并阅读"
                                        ...
                                        _cE("view", _uM("class" to "flex-1")),
                                        _cV(_component_cl_switch, _uM("modelValue" to checked4.value, "onUpdate:modelValue" to fun(`$event`: Boolean){
                                            checked4.value = `$event`
                                        }
                                        ), null, 8, _uA(
                                            "modelValue",
                            ...
                            _cV(unref(GenPagesDemoComponentsItemClass), _uM("label" to unref(t)("纵向排列")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                return _uA(
                                    _cE(Fragment, null, RenderHelpers.renderList(options.value, fun(item, index, __index, _cached): Any {
                                        return _cV(_component_cl_checkbox, _uM("modelValue" to checked.value, "onUpdate:modelValue" to fun(`$event`: UTSArray<String>){
                                            checked.value = `$event`
                                        }
                                        , "key" to index, "value" to item.value, "pt" to object : UTSJSONObject() {
                            ...
                            _cV(unref(GenPagesDemoComponentsItemClass), _uM("label" to unref(t)("自定义")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                return _uA(
                                    _cE("view", _uM("class" to "mb-3 flex flex-row flex-wrap"), _uA(
                                        _cE(Fragment, null, RenderHelpers.renderList(options.value, fun(item, index, __index, _cached): Any {
                                            return _cV(_component_cl_checkbox, _uM("modelValue" to checked3.value, "onUpdate:modelValue" to fun(`$event`: UTSArray<String>){
